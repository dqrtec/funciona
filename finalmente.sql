...
--
-- Host: localhost
-- Generation Time: 02-Dez-2019 às 12:09
...
CREATE TABLE `radar` (
  `rad_cpf` varchar(15) DEFAULT NULL,
  `rad_cnpj` varchar(20) DEFAULT NULL,
  `rad_rg` varchar(20) DEFAULT NULL,
  `rad_email` varchar(30) NOT NULL,
  `rad_senha` varchar(20) NOT NULL,
  `rad_role` varchar(30) NOT NULL,
  `rad_informacao_adicional` varchar(400) NOT NULL,
  ...
  `rad_tags` varchar(400) NOT NULL,
  `rad_servicos` varchar(400) NOT NULL,
  `rad_titulo` varchar(400) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `radar` (`rad_cpf`, `rad_cnpj`, `rad_rg`, `rad_email`, `rad_senha`, `rad_role`, `rad_informacao_adicional`, `rad_end_id`, `rad_autor`, `rad_categoria`, `rad_descricao`, `rad_seg_id`, `rad_tags`, `rad_servicos`, `rad_titulo`) VALUES
('123', '', '', 'daniel@123', '123', 'daniel', 'trabalha com artesanato', 1, 'desafiando o sistema ', 'cat 1', 'sempre i no vando', 1, 'artesanato jovem', 'sarvico 1', 'como desfiar'),
(NULL, NULL, NULL, 'recife@recife.com', '123', '1', 'vendemos artes', 3, 'juninho pernambuco', NULL, NULL, NULL, 'telas', 'produção de telas', 'Telas a 8 arte');
...
--
-- Indexes for table `habilidade_segmento`
--
